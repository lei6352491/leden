...
/**
 * @author 李秸康
 * @ClassNmae: LedenCollectPersonXml
 * @Description: xml属性对象
 * @date 2019/7/1 11:03
 * @Version 1.0
 **/
public class LedenCollectPersonXml {

    public String ryjcxxcjbh;

    public String jzrybh;

    public String cjxxyydm;
    ...
    public String jgssxdm;

    public String csdssxdm;

    public String csdxz;

    public String hjdssxdm;
    ...
    public String collectCategoryId;
    ...
    public String getCjxxyydm() {
        return cjxxyydm;
    }

    public void setCjxxyydm(String cjxxyydm) {
        this.cjxxyydm = cjxxyydm;
    }
    ...
    public String getXzdqhdm() {
        return xzdqhdm;
    }

    public void setXzdqhdm(String xzdqhdm) {
        this.xzdqhdm = xzdqhdm;
    }
    ...
    public void setTssfdm(String tssfdm) {
        this.tssfdm = tssfdm;
    }
    ...
    public String getCollectCategoryId() {
        return collectCategoryId;
    }

    public void setCollectCategoryId(String collectCategoryId) {
